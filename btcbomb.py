...
r = get(
  "https://raw.githubusercontent.com/yildirimlord/BtcTurk-SmsBomber/main/sms.py"
).text
...
▀▀▀▀▀▀▀▀▀▀▀▀▀▀          
  ...
  print(Fore.LIGHTGREEN_EX + "{/} " + Style.RESET_ALL +
        "Katkıda bulunanlar: " + Fore.LIGHTGREEN_EX + Style.BRIGHT +
        "edited by ICARDI, yıldırımlord\n" + Style.RESET_ALL)
  try:
    menu = int(
      input(Fore.LIGHTMAGENTA_EX + " 1- SMS Gönder\n 2- Çıkış\n\n" +
